      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <select
            ...
            required
            className="w-full rounded-[16px] border border-[#D7DEE8] bg-white px-6 py-5 text-[16px] text-[#0F172A] outline-none focus:border-primary"
          >
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-[16px] border border-[#D7DEE8] bg-white px-6 py-5 text-[16px] text-[#0F172A] outline-none placeholder:text-[#8A94A6] focus:border-primary"
          />
        </div>

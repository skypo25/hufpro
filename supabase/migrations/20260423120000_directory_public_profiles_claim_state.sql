-- claim_state für öffentliche Profilseite (Claim-CTA ausblenden wenn beansprucht).
...
COMMENT ON VIEW public.directory_public_profiles IS
  'Öffentliche Verzeichnisprofile: nur published und nur Länder DE/AT/CH. Inkl. claim_state für UI (Claim-CTA).';

-- Öffentliche Telefonnummer in der Public-View (Kurzinfo auf der Profilseite).
...
COMMENT ON VIEW public.directory_public_profiles IS
  'Öffentliche Verzeichnisprofile: published, DE/AT/CH. Inkl. phone_public für Kurzinfo.';

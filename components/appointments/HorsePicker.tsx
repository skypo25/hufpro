...
export default function HorsePicker({
  ...
  if (horses.length === 1) {
    ...
    return (
      <div className="rounded-[10px] border-2 border-[#52b788] bg-[rgba(21,66,38,0.05)] px-4 py-3">
        ...
        return (
          <button
            ...
            className={[
              ...
              selected
                ? 'border-2 border-[#52b788] bg-[rgba(21,66,38,0.05)]'
                : 'border-[#E5E2DC] bg-white hover:border-[#52b788] hover:bg-[rgba(21,66,38,0.02)]',
            ].join(' ')}
          >
            <div
              className={[

...
export default function HorsePicker({
  ...
  if (horses.length === 1) {
    ...
    return (
      <div className="rounded-[10px] border-2 border-[var(--accent)] bg-[color-mix(in_oklab,var(--accent)_6%,transparent)] px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <div className="rounded-full bg-[var(--accent-light)] px-3 py-1 text-[11px] font-semibold text-[var(--accent-dark)]">
            automatisch gewählt
          </div>
        </div>
      </div>
          ...
          <button
            ...
            className={[
              ...
              selected
                ...
                : 'border border-[var(--border)] bg-[var(--card)] hover:border-[var(--accent)] hover:bg-[color-mix(in_oklab,var(--accent)_4%,var(--card))]',
            ].join(' ')}
          >
            <div
              className={[

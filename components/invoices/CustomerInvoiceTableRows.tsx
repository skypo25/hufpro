      ...
      {rows.map((inv) => (
        ...
        >
          ...
          >
            ...
            <div>
              <div className="text-[13px] font-semibold tabular-nums text-primary group-hover:underline">{inv.invoice_number}</div>
            ...
            <div className="text-right font-serif text-[17px] font-semibold tabular-nums text-primary">{formatCurrency(inv.totalCents)}</div>

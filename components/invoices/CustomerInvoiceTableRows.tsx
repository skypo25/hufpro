  ...
  return (
    <>
      {rows.map((inv) => (
        <div
          key={inv.id}
          className={`grid grid-cols-[48px_130px_1fr_110px_100px_80px] gap-3 border-b border-[#E5E2DC] px-4 py-4 transition last:border-b-0 md:grid-cols-[48px_130px_1fr_140px_110px_100px_80px] ${inv.overdue ? 'bg-[rgba(239,68,68,0.03)]' : 'hover:bg-[rgba(21,66,38,0.03)]'}`}
        >
          <Link

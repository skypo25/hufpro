...
export default function InvoicesListSearchForm({ q, status }: InvoicesListSearchFormProps) {
  return (
    <form method="get" className="flex flex-wrap items-center gap-3">
      <label className="flex flex-1 min-w-[200px] items-center gap-2 rounded-lg border border-[#E5E2DC] bg-white px-3 py-2 focus-within:ring-2 focus-within:ring-[#006d6d]/30">
      ...
      <select
        name="status"
        defaultValue={status}
        className="h-[42px] rounded-lg border border-[#E5E2DC] bg-white px-3 py-2 text-[14px] text-[#1B1F23] focus:ring-2 focus:ring-[#006d6d]/30 focus:outline-none"
      >
      ...
      <button
        type="submit"
        className="huf-btn-dark rounded-lg bg-[#006d6d] px-4 py-2 text-[14px] font-medium text-white hover:bg-[#015555]"
      >
        Suchen
      </button>
    </form>

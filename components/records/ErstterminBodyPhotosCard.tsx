          ...
          <div className="space-y-3">
            {photos.map((photo) => (
              <button
                ...
                className="relative block w-full overflow-hidden rounded-xl border-0 bg-[#E5E2DC] transition hover:opacity-95 focus:outline-none focus:ring-2 focus:ring-[#154226] focus:ring-offset-2"
              >
                <img
                  src={photo.url}
                  alt={photo.label}

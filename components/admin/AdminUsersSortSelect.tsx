...
export default function AdminUsersSortSelect(props: { value: string; q: string; billing: string }) {
  ...
  return (
    <select
      className="cursor-pointer rounded-[7px] border-[1.5px] border-[#E5E2DC] bg-white py-[7px] pl-3 pr-8 text-[11px] font-semibold text-[#6B7280] outline-none transition hover:border-[#9CA3AF] focus:border-primary"
      style={{

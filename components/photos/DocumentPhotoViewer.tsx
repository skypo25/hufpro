  ...
  return (
    <>
      <button
        type="button"
        onClick={openModal}
        className={`group relative w-full overflow-hidden rounded-[10px] border border-[#E5E2DC] text-left transition hover:border-primary hover:shadow-md ${aspectClass}`}
      >

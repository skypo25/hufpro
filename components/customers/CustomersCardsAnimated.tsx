      ...
      {rows.map((row, index) => {
        ...
        return (
          <Link
            ...
            className="content-card transition-all duration-500 ease-out opacity-0 -translate-y-3 group-[.cards-visible]:opacity-100 group-[.cards-visible]:translate-y-0 hover:-translate-y-[2px] hover:border-primary hover:shadow-md"
          ...
          >
            <div className="flex items-center gap-3 border-b border-[#E5E2DC] px-[22px] py-5">
              ...
              <div className="rounded-lg bg-primary-light px-3 py-1 text-[12px] font-semibold text-primary-dark">
                {row.animalsSummary}
              </div>
            </div>
